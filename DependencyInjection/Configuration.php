    ...
    public function getConfigTree()
    {
        ...
        $treeBuilder->root('fos_comment', 'array')
            ->children()
                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('commentable_thread')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('state_comment')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('fos_comment_state_comment')->end()
                                ->scalarNode('name')->defaultValue('fos_comment_state_comment')->end()
                            ->end()
                        ->end()
                ...
                ->booleanNode('moderate')->defaultValue(false)->end()
                    ...
                    ->children()
                        ->arrayNode('comment')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('moderate')->cannotBeEmpty()->defaultValue('ROLE_ADMIN')->end()
                            ->end()
                        ->end()
                        ->arrayNode('thread')->addDefaultsIfNotSet()
                            ->children()
                    ...
                    ->children()
                        ...
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('state_comment')->cannotBeEmpty()->defaultValue('fos_comment.form_factory.state_comment.default')->end()
